...
class AIResponse(BaseModel):
    ...
    needs_confirmation: bool = Field(default=False, description="Whether to ask for confirmation before executing")
    collecting_info: bool = Field(default=False, description="Whether more info is needed from user")